...
inputUsername.addEventListener('input', event => {
  ...
  if (!checkInputCharacter) { // Se não for válido
    insertParagraphIntoDOM(invalidInputValue)
    return 
  }  
  // Se for válido
  insertParagraphIntoDOM(validInputValue)
...
form.addEventListener('submit', event => {
  ...
  const checkInputValue = testUsername(inputUsername.value)
  ...
  if (!checkInputValue) { // Se não for válido
